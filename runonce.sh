...
echo "***********************************"
docker exec -it jenkins_node sh -c "java -jar agent.jar -jnlpUrl http://172.16.11.8:8080/computer/jenkins_node/slave-agent.jnlp -workDir \"/root/jenkins_slave\""
echo "***********************************"
...
echo "***********************************"
docker exec -it keycloak sh -c "/opt/jboss/keycloak/bin/create-realm.sh"  > keycloak_create.login
