...
ipa cert-request /tmp/certs/gitea.tooling.test.csr --principal=host/gitea.tooling.test --chain --certificate-out=/tmp/certs/gitea.tooling.test.pem
...
ipa cert-request /tmp/certs/jenkins.tooling.test.csr --principal=host/jenkins.tooling.test --chain --certificate-out=/tmp/certs/jenkins.tooling.test.pem
...
ipa cert-request /tmp/certs/nexus.tooling.test.csr --principal=host/nexus.tooling.test --chain --certificate-out=/tmp/certs/nexus.tooling.test.pem
...
ipa cert-request /tmp/certs/keycloak.tooling.test.csr --principal=host/keycloak.tooling.test --chain --certificate-out=/tmp/certs/keycloak.tooling.test.pem
...
ipa cert-request /tmp/certs/portainer.tooling.test.csr --principal=host/portainer.tooling.test --chain --certificate-out=/tmp/certs/portainer.tooling.test.pem
