...
${JENKINS NetCICD}   http://jenkins.tooling.test:8084/job/Infraautomator/computation/console
...
Get infraautomator repositories
    Go To                       http://jenkins.tooling.test:8084/job/Infraautomator/computation/console
